...
class statusUserPage extends StatefulWidget {
  const statusUserPage({Key? key}) : super(key: key);

  @override
  _statusUserPage createState() => _statusUserPage();
}

class _statusUserPage extends State<statusUserPage> {
// text fields' controllers
                  ...
                  onPressed: () async {
                    ...
                    if (date != null) {
                      await _usersCollection
                          .add({"date": date, "description": description});
  ...
  Future<void> _update([DocumentSnapshot? documentSnapshot]) async {
    if (documentSnapshot != null) {
      ...
      descController.text = documentSnapshot['description'].toString();
    }
                  ...
                  onPressed: () async {
                    ...
                    if (date != null) {
                      await _usersCollection
                          ...
                          .update({"date": date, "description": description});
                      dateController.text = '';
                      descController.text = '';
                      Navigator.of(context).pop();
                    }
